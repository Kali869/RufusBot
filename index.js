...
class GuideBot extends Client {
  constructor(options) {
    ...
    this.settings = new Enmap({ name: "settings", cloneLevel: "deep", fetchAll: true, autoFetch: true });
...
const init = async () => {
  try {await connect("mongodb+srv://Cellor:JasJon01@cluster0-hjcwy.mongodb.net/UserMessageVault?retryWrites=true&w=majority",{
    useNewUrlParser: true,
    useFindAndModify: false
  }
  );
  if (connection) {
    Logger.log("MongoDB is Logged in");
  }}
  catch (err) {
    Logger.log(err);
  }
